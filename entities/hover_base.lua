...
function ENT:Bang(p) --######## The effect, and killing the player if they're flying @RononDex
	...
	self:EmitSound(Sound("haloxplosion.mp3"),100,100); --Play the jumper's explosion sound(Only good explosion sound i have)
	local fx = EffectData();
...
if CLIENT then
	...
	function HALO_Speeder_Reticles(self,WeaponsPos) 
		local p = LocalPlayer();
