...
if CLIENT then
	...
	function ENT:Think()
		...
		if(Flying) then
			self.EnginePos = {
				self:GetPos()+self:GetForward()*1800+self:GetUp()*-20+self:GetRight()*373,
				self:GetPos()+self:GetForward()*1850+self:GetUp()*250+self:GetRight()*770,
				self:GetPos()+self:GetForward()*1800+self:GetUp()*-20+self:GetRight()*-375,
				self:GetPos()+self:GetForward()*1850+self:GetUp()*280+self:GetRight()*-750,
			}
			self:Effects();
		end
	end	
